...
// alef:hash:8d718b37cc40b45ab52f47f6a647dddb659e00efeb9ed796a76c1743c7375d3f
...
assertTrue(result.content().length() >= 10, "expected length >= 10");assertTrue(java.util.Optional.ofNullable(result.chunks()).orElse(java.util.List.of()).size() >= 2, "expected at least 2 elements");        assertTrue(result.chunks().orElse(java.util.List.of()).stream().allMatch(c -> c.content() != null && !c.content().isBlank()), "expected true");        assertTrue(result.chunks().orElse(java.util.List.of()).stream().allMatch(c -> c.metadata().headingContext().isPresent()), "expected true");        assertTrue(result.chunks().orElse(java.util.List.of()).stream().findFirst().map(c -> c.metadata().headingContext().isPresent()).orElse(false), "expected true");
    }
