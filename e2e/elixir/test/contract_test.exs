...
# alef:hash:d5be3a8804f59b3872362bc0fba1a476e326ad211579c9b74d6de46ffb184c4b
...
defmodule E2e.ContractTest do
  ...
  describe "config_chunking_prepend_heading_context" do
    test "config_chunking_prepend_heading_context" do
      ...
      assert result.chunks_have_heading_context == true
      assert result.first_chunk_starts_with_heading == true
    end
  end
